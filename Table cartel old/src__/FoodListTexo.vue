                        ...
                        <div style="background-color: #fff; padding: 1px 0 6px; ">
                            <div class="card">
                                <div class="settings_settings">
                                    ...
                                    <div class="restaurent_header_heading food_list_header_text"><p>Food List</p></div>
...
<script>
    ...
    export default {
        ...
        methods: {
            fetchData () {
                this.loading = true
                axios.get('http://clients.itsd.com.bd/table-cartel/wp-json/Table-cartel/v1/get-all-term-food/' + this.data.id + '/')
                    .then((resp) => {
