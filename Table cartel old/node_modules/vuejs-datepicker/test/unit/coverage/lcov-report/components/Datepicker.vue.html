...
<html lang="en">
<head>
    <title>Code coverage report for components/Datepicker.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">components/</a> Datepicker.vue
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>188/194</span>
      </div>
      <div class='fl pad1y space-right2'>
...
895
896
897</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">83×</span>
<span class="cline-any cline-yes">83×</span>
<span class="cline-any cline-yes">2559×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2561×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5135×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5135×</span>
<span class="cline-any cline-yes">3882×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1253×</span>
...
export default {
  ...
  watch: {
    value (value) {
<span class="cstat-no" title="statement not covered" >      this.setValue(value)</span>
    },
    initialView () {
<span class="cstat-no" title="statement not covered" >      this.setInitialView()</span>
    }
  },
  computed: {
    formattedValue () {
...
&nbsp;
    ...
    currMonthName () {
      ...
      return DateUtils.getMonthNameAbbr(d.getMonth(), this.fullMonthName ? <span class="branch-0 cbranch-no" title="branch not covered" >this.translation.months.original </span>: this.translation.months.abbr)
    },
    currYear () {
      const d = new Date(this.pageDate)
  ...
  methods: {
    ...
    showMonthCalendar () {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.isInline) {
        document.addEventListener('click', this.clickOutside, false)
      }
    },
    showYearCalendar () {
...
<span class="cstat-no" title="statement not covered" >          disabled = true</span>
        }
      }
...
&nbsp;
     ...
     */
    clickOutside (event) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.$el &amp;&amp; !this.$el.contains(event.target)) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isInline) {
<span class="cstat-no" title="statement not covered" >          return this.showDayCalendar()</span>
        }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Aug 27 2017 09:34:43 GMT+0100 (BST)
</div>
</div>
