...
export var loaded = new _Promise(function (resolve, reject) {
 ...
 * ```
 */
export var load = function load(apiKey, version, libraries, loadCn) {
  ...
  if (!setUp) {
    ...
    var url = baseUrl + 'maps/api/js?' + _Object$keys(options).map(function (key) {
